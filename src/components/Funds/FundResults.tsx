        ...
        <div style={{margin: '25px'}}>
            <Box display={'flex'} gap={25} marginBottom={'50px'}>
                ...
                <div style={{display: 'flex',  marginLeft: 'auto'}}>
                    <div onClick={() => setView('grid')}><GridViewButton selected={currentView === 'grid'} onClick={() => setView('grid')}/></div>
                    <div onClick={() => setView('list')}><ListViewButton selected={currentView === 'list'} onClick={() => setView('list')}/></div>
                </div>
            </Box>
